...
int main()
{
	...
	MySimpleGarmin(G, "Northampton", MinimumDistance, "(mileage, using minimum distance)");
	MySimpleGarmin(G, "Pittsfield", MinimumDistance, "(mileage, using minimum distance)");
	getchar();
	return 0;
} // end main
